              ...
              <table className="w-full text-left text-xs">
                <thead className="bg-zinc-950 text-zinc-400 uppercase border-b border-zinc-800">
                  <tr>
                    ...
                    <th className="p-3">Registered Date & Time</th>
                ...
                <tbody className="divide-y divide-zinc-800/60">
                  {registeredUsers.map((u) => (
                    <tr key={u.id} className="hover:bg-zinc-800/40 transition-colors">
                      ...
                      {/* Exact Date & Time for Registered Users */}
                        ...
                        {u.registeredAt ? (
                          <div>
                            ...
                            <div className="text-[10px] text-amber-400 font-bold flex items-center gap-1 mt-0.5">
                              ⏰ {new Date(u.registeredAt).toLocaleTimeString('en-IN', { hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: true })}
                            </div>
                          </div>
                        ) : (
